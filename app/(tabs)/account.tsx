  ...
  const renderRow = (IconComponent: any, title: string, value?: string, color: string = '#0A84FF', isLast: boolean = false, onPress?: () => void) => (
    <TouchableOpacity style={styles.row} activeOpacity={0.7} onPress={onPress}>
      ...
      <View style={[styles.rowContent, !isLast && styles.rowBorder]}>
         ...
         <View style={{flexDirection: 'row', alignItems: 'center'}}>{value && <Text style={styles.rowValue}>{value}</Text>}<ChevronRight color="#48484A" size={18} /></View>
      </View>
    </TouchableOpacity>
  );
...
const styles = StyleSheet.create({
  ...
  authBox: { borderRadius: SIZES.radiusSquircle, borderWidth: 0.8, borderColor: COLORS.border, overflow: 'hidden' },
  ...
  authTitle: { color: COLORS.text, fontSize: 28, fontWeight: '800', marginBottom: 6, letterSpacing: -0.5 },
  authSub: { color: COLORS.textMuted, fontSize: 14, marginBottom: 25 },
  
  inputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 16, height: 54, marginBottom: 15, paddingHorizontal: 15, borderWidth: 0.8, borderColor: COLORS.border },
  ...
  authSwitchText: { color: COLORS.primary, fontSize: 14, fontWeight: '600' },
  
  profileCard: { borderRadius: SIZES.radiusSquircle, marginTop: 10, marginBottom: 20, borderWidth: 0.8, borderColor: COLORS.border, overflow: 'hidden' },
  profileCardInside: { flexDirection: 'row', alignItems: 'center', padding: 20 },
  avatar: { width: 70, height: 70, borderRadius: 35, borderWidth: 2, borderColor: 'rgba(255,255,255,0.1)' },
  profileInfo: { flex: 1, marginLeft: 16 },
  profileName: { color: COLORS.text, fontSize: 22, fontWeight: '800', marginBottom: 4, letterSpacing: -0.5 },
  ...
  groupTitle: { color: COLORS.textMuted, fontSize: 12, fontWeight: '700', marginLeft: 15, marginBottom: 8, marginTop: 10, letterSpacing: 1 },
  group: { borderRadius: SIZES.radiusCard, overflow: 'hidden', marginBottom: 25, borderWidth: 0.8, borderColor: COLORS.border },
  ...
  rowBorder: { borderBottomWidth: 0.8, borderBottomColor: COLORS.border },
  ...
  modalBox: { backgroundColor: '#121215', width: '100%', borderRadius: 24, padding: 30, alignItems: 'center', borderWidth: 0.8, borderColor: COLORS.border },
  modalTitle: { color: COLORS.text, fontSize: 22, fontWeight: '800', marginBottom: 15 },
  modalMsg: { color: COLORS.textSecondary, fontSize: 16, textAlign: 'center', lineHeight: 24, marginBottom: 25 },
  modalBtn: { backgroundColor: COLORS.gold, width: '100%', paddingVertical: 14, borderRadius: 16, alignItems: 'center' },
